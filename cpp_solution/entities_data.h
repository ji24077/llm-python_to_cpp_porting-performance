// Auto-generated from Python html.entities.html5 (data table, not a markdown parser).
// Maps HTML5 entity name (without leading & or trailing ;) to its UTF-8 expansion.
// Regenerated for fence-info unescapeAll parity (Stage 4 closure).
#pragma once
#include <unordered_map>
#include <string>

inline const std::unordered_map<std::string, std::string>& html5_entities() {
